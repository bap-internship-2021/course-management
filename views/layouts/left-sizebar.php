        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="in">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href=".?action=subjects" aria-expanded="false">
                        <i class="mdi mdi-account-network"></i>
                        <span class="hide-menu">Subject</span>
                    </a>
                </li>
                    <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href=".?action=students" aria-expanded="false">
